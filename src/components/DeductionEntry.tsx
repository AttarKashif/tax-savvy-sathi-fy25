...
export const DeductionEntry: React.FC<DeductionEntryProps> = ({
  ...
  return <div className="space-y-6">
      ...
      {hasValidIncome && <Card className="bg-gradient-to-r from-slate-900/90 to-slate-800/90 border-slate-700/50 backdrop-blur-sm rounded-2xl shadow-2xl">
          <CardContent className="pt-6 bg-slate-800">
            <div className="flex flex-col items-center gap-4">
              ...
              <Button onClick={onCalculate} size="lg" className="bg-slate-600 hover:bg-slate-700 rounded-xl px-8 py-3 shadow-lg hover:shadow-xl transition-all duration-300">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-600/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input type="number" value={hraDetails.monthlyRent || ''} onChange={e => setHraDetails(prev => ({
                ...prev,
                monthlyRent: Number(e.target.value) || 0
              }))} placeholder="Enter monthly rent" className={inputClassName} />
              </div>
              <div className="space-y-2">
                <Label className={labelClassName}>City Type</Label>
                <select value={hraDetails.cityType} onChange={e => setHraDetails(prev => ({
                ...prev,
                cityType: e.target.value as 'metro' | 'non-metro'
              ...
              <div className="space-y-2">
                ...
                <Input type="number" value={income.basicSalary || ''} readOnly className="bg-slate-700/50 border-slate-600/40 text-slate-400" placeholder="Enter in Income section" />
              </div>
              <div className="space-y-2">
                <Button onClick={calculateHRAExemption} className="bg-slate-600 hover:bg-slate-700 rounded-xl">
                  Calculate HRA Exemption
                </Button>
              </div>
            </div>
            {deductions.hra > 0 && <div className="mt-4 p-3 bg-slate-800/50 rounded-lg border border-slate-600/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.lta || ''} onChange={e => handleDeductionUpdate('lta', Number(e.target.value) || 0)} placeholder="Enter LTA exemption" className={inputClassName} />
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.professionalTax || ''} onChange={e => handleDeductionUpdate('professionalTax', Number(e.target.value) || 0)} placeholder="Max ₹2,500" className={inputClassName} />
              <p className="text-xs text-slate-400">Annual professional tax paid</p>
            </div>

            <div className="space-y-2">
              <Label className={labelClassName}>Gratuity Exemption</Label>
              <Input type="number" value={deductions.gratuity || ''} onChange={e => handleDeductionUpdate('gratuity', Number(e.target.value) || 0)} placeholder="Enter gratuity amount" className={inputClassName} />
              <p className="text-xs text-slate-400">As per gratuity rules</p>
            </div>

            <div className="space-y-2">
              <Label className={labelClassName}>Leave Encashment</Label>
              <Input type="number" value={deductions.leaveEncashment || ''} onChange={e => handleDeductionUpdate('leaveEncashment', Number(e.target.value) || 0)} placeholder="Enter leave encashment" className={inputClassName} />
        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-600/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input type="number" value={deductions.section80C || ''} onChange={e => handleDeductionUpdate('section80C', Number(e.target.value) || 0)} placeholder="PPF, ELSS, Insurance" className={inputClassName} />
              ...
              <div className="space-y-2">
                ...
                <Input type="number" value={deductions.section80CCC || ''} onChange={e => handleDeductionUpdate('section80CCC', Number(e.target.value) || 0)} placeholder="Pension fund" className={inputClassName} />
                <p className="text-xs text-slate-400">Pension fund contributions</p>
              </div>

              <div className="space-y-2">
                <Label className={labelClassName}>Section 80CCD (1)</Label>
                <Input type="number" value={deductions.section80CCD || ''} onChange={e => handleDeductionUpdate('section80CCD', Number(e.target.value) || 0)} placeholder="NPS employee" className={inputClassName} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.section80D || ''} onChange={e => handleDeductionUpdate('section80D', Number(e.target.value) || 0)} placeholder="Health insurance premium" className={inputClassName} />
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.section80DDB || ''} onChange={e => handleDeductionUpdate('section80DDB', Number(e.target.value) || 0)} placeholder="Medical expenses" className={inputClassName} />
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.section80E || ''} onChange={e => handleDeductionUpdate('section80E', Number(e.target.value) || 0)} placeholder="Education loan interest" className={inputClassName} />
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.section80EE || ''} onChange={e => handleDeductionUpdate('section80EE', Number(e.target.value) || 0)} placeholder="Max ₹50,000" className={inputClassName} />
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.section80EEA || ''} onChange={e => handleDeductionUpdate('section80EEA', Number(e.target.value) || 0)} placeholder="Max ₹1.5 Lakh" className={inputClassName} />
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.section80G || ''} onChange={e => handleDeductionUpdate('section80G', Number(e.target.value) || 0)} placeholder="Charitable donations" className={inputClassName} />
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.section80TTA || ''} onChange={e => handleDeductionUpdate('section80TTA', Number(e.target.value) || 0)} placeholder="Savings interest" className={inputClassName} />
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.section80U || ''} onChange={e => handleDeductionUpdate('section80U', Number(e.target.value) || 0)} placeholder="Disability deduction" className={inputClassName} />
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.section80CCG || ''} onChange={e => handleDeductionUpdate('section80CCG', Number(e.target.value) || 0)} placeholder="Equity savings scheme" className={inputClassName} />
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={deductions.nps || ''} onChange={e => handleDeductionUpdate('nps', Number(e.target.value) || 0)} placeholder="Max ₹50,000" className={inputClassName} />
      ...
      <Card className={cardClassName}>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input type="number" value={deductions.homeLoanInterest || ''} onChange={e => handleDeductionUpdate('homeLoanInterest', Number(e.target.value) || 0)} placeholder="Max ₹2,00,000" className={inputClassName} />
